...
// SampleEmail holds a training email with subject and body.
type SampleEmail struct {
	Subject string
	Body    string
}

// SafeEmails contains 47 legitimate business and personal emails.
var SafeEmails = []SampleEmail{
...
// SpamEmails contains 44 unsolicited marketing, scam, and junk emails.
var SpamEmails = []SampleEmail{
...
// AttackEmails contains 51 phishing, social engineering, and malware delivery emails.
var AttackEmails = []SampleEmail{
